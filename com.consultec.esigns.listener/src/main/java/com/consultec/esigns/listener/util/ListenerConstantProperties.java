...
public class ListenerConstantProperties {
  ...
  public static final String URL_TSA =
      PropertiesManager.getInstance().getValue(PropertiesManager.TSA_URL_SERVER);
  ...
  public static final String KEYSTORE_ACCESS_MODE =
      PropertiesManager.getInstance().getValue(PropertiesManager.KEYSTORE_ACCESS_MODE);

  /** The Constant PDFVIEWER_EXECPATH. */
  public static final String PDFVIEWER_EXECPATH =
      PropertiesManager.getInstance().getValue(PropertiesManager.PROPERTY_ICEPDF_PATH);

  /** The Constant PDFVIEWER_EXECDEP. */
  public static final String PDFVIEWER_EXECDEP =
      PropertiesManager.getInstance().getValue(PropertiesManager.PROPERTY_ICEPDF_DLLS);
   ...
   */
  public static int launchClientApp(String id) throws IOException, InterruptedException {
