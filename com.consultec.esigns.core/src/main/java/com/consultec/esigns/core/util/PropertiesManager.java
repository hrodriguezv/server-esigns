...
public class PropertiesManager {
  ...
  public static final String PROPERTY_USER_HOME_WORKSPACE = "user.default.home";

  /** The Constant PROPERTY_USER_HOME_PDFDOCUMENT. */
  public static final String PROPERTY_USER_HOME_PDFDOCUMENT = "user.default.pdfdocumentname";

  /** The Constant PROPERTY_USER_HOME_ESIGNEDDOCUMENT. */
  public static final String PROPERTY_USER_HOME_ESIGNEDDOCUMENT = "user.default.pdfesigneddocname";

  /** The Constant PROPERTY_USER_HOME_STROKEDOCUMENT. */
  public static final String PROPERTY_USER_HOME_STROKEDOCUMENT = "user.default.pdfstrokedocname";

  /** The Constant PROPERTY_USER_BASE_HOME. */
  public static final String PROPERTY_USER_BASE_HOME = "user.default.basehome";

  /** The Constant PROPERTY_OPERATOR_CERTIFICATE. */
  public static final String PROPERTY_OPERATOR_CERTIFICATE = "operator.default.certificate";
  public static final String KEY_OPERATOR_CERTIFICATE = "operator.password.certificate";
  ...
  public static final String PROPERTY_ICEPDF_PATH = "user.default.icepdfjarpath";

  /** The Constant PROPERTY_ICEPDF_DLLS. */
  public static final String PROPERTY_ICEPDF_DLLS = "user.default.icepdfdllpath";
  ...
  public static final String PROPERTY_USER_STROKE_LOCATION = "stroke.location.value";
  ...
  public static final String DELETE_DATA_ON_EXIT = "stroke.delete.data.onexit";
  ...
  /**
   * Reads the properties file that ships with the viewer jar and stores the default properties in
   * the preferences backing store. This is only done on first launch.
   */
  private static void setupDefaultProperties() {
    ...
    try (InputStream in =
        classLoader.getResourceAsStream(DEFAULT_PROP_FILE_PATH + DEFAULT_PROP_FILE)) {
      ...
      if (in != null) {
        ...
        throw new FileNotFoundException("Error loading default properties file");
